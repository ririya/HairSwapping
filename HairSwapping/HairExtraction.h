...
public:
	...
	Hair(Mat p_hairMask, int p_hairConnectionPointLocationX, int p_hairConnectionPointLocationY, int p_hairConnectionPointDistanceToJ_X, int p_hairConnectionPointDistanceToJ_Y)
	{
		hairMask = p_hairMask;
...
static const int EROSION_SIZE = 2;
